...
**如遇不能打开程序，请确认是否安装了vs2010运行库，如果没有请下载vs2010运行库进行安装，或者单独下载msvcp100.dll、msvcr100.dll两个动态链接库。**   
...
* 1、 选择“歌词输入目录”和“歌词输出目录”或者将LyricTools.exe与bass.dll放入歌词目录或者将歌词文件放入LyricTools.exe所在目录  
